...
<form method="post" action="{{url('/shops', $shop->id)}}" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div class="shops-edit-second">
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input class="large-width" type="text" name="name" value="{{old('name', $shop->name)}}">
            @if($errors->has('name'))
        ...
        <tr>
          ...
          <td>
            <input class="large-width" type="text" name="address" value="{{old('address', $shop->address)}}" placeholder="例）東京都渋谷区神宮前2-23-7">
        ...
        <tr>
          <th>定休日</th>
          <td>
            <input class="medium-width" type="text" name="close" value="{{old('close', $shop->close)}}" placeholder="例）月曜日、祝日">
            @if($errors->has('close'))
        ...
        <tr>
          <th>電話番号</th>
          <td>
            <input class="medium-width" type="text" inputmode="numeric" pattern="\d*" name="tel" value="{{old('tel', $shop->tel)}}" placeholder="例）0312345678">
            @if($errors->has('tel'))
        ...
        <tr>
          <th>店舗HP（URL）</th>
          <td>
            <input class="large-width" type="text" name="url" value="{{old('url', $shop->url)}}" placeholder="例）https://example.com">
            @if($errors->has('url'))
        ...
        <tr>
          <th>店舗トップ画像</th>
          <td>
            <input type="file" name="image" value="{{old('image', $shop->image)}}">
            @if($errors->has('image'))
        ...
        <tr>
          <th>備考</th>
          <td><textarea class="large-width" name="content" placeholder="例）開放的な空間で作業に長時間の向いています。">{{old('content', $shop->content)}}</textarea></td>
        </tr>
        <tr>
          <th>注意事項</th>
